...
<tbody>
<tr><td>timeSincePressed</td><td>number</td><td>Read-only</td><td>Yes</td><td>Time in seconds since the brush trigger was last pressed</td></tr>
<tr><td>timeSinceReleased</td><td>number</td><td>Read-only</td><td>Yes</td><td>Time in seconds since the brush trigger was last released</td></tr>
<tr><td>triggerIsPressed</td><td>boolean</td><td>Read-only</td><td>Yes</td><td>Check whether the brush trigger is currently pressed</td></tr>
<tr><td>triggerIsPressedThisFrame</td><td>boolean</td><td>Read-only</td><td>Yes</td><td>Check whether the brush trigger was pressed in the current frame</td></tr>
<tr><td>distanceMoved</td><td>number</td><td>Read-only</td><td>Yes</td><td>The distance moved by the brush</td></tr>
<tr><td>distanceDrawn</td><td>number</td><td>Read-only</td><td>Yes</td><td>The distance drawn by the brush (i.e. distance since the trigger was last pressed)</td></tr>
<tr><td>position</td><td><a href="vector3.md">Vector3</a></td><td>Read-only</td><td>Yes</td><td>The 3D position of the Brush Controller's tip</td></tr>
<tr><td>rotation</td><td><a href="rotation.md">Rotation</a></td><td>Read-only</td><td>Yes</td><td>The 3D orientation of the Brush Controller's tip</td></tr>
<tr><td>direction</td><td><a href="vector3.md">Vector3</a></td><td>Read-only</td><td>Yes</td><td>The vector representing the forward direction of the brush</td></tr>
<tr><td>size</td><td>number</td><td>Read/Write</td><td>Yes</td><td>The current brush size</td></tr>
<tr><td>pressure</td><td>number</td><td>Read-only</td><td>Yes</td><td>Brush pressure is determined by how far the trigger is pushed in</td></tr>
<tr><td>type</td><td>string</td><td>Read/Write</td><td>Yes</td><td>The current brush type</td></tr>
<tr><td>speed</td><td>number</td><td>Read-only</td><td>Yes</td><td>How fast the brush is currently moving</td></tr>
<tr><td>colorRgb</td><td><a href="color.md">Color</a></td><td>Read/Write</td><td>Yes</td><td>Gets or set brush color</td></tr>
<tr><td>colorHsv</td><td><a href="vector3.md">Vector3</a></td><td>Read/Write</td><td>Yes</td><td>Gets or set brush color using a Vector3 representing hue, saturation and brightness</td></tr>
<tr><td>colorHtml</td><td>string</td><td>Read/Write</td><td>Yes</td><td>The color of the brush as a valid HTML color string (either hex values or a color name)</td></tr>
