...
<tr><td>sqrMagnitude</td><td>number<br>Read-only</td><td>The square of the length of this vector (faster to calculate if you're just comparing two lengths)</td></tr>
