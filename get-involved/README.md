...
* Contribute to the docs - send in corrections or improvements or fill in any gaps you find. (We have a [TODO list](../docs-todo.md) just for the docs)
...
* Try out the [beta version](../alternate-and-experimental-builds/open-brush-beta-docs.md) or one of the [experimental builds](../alternate-and-experimental-builds/) and share bugs you find or any other feedback.
