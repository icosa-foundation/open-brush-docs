...
Open Brush finally has [layers support](../alternate-and-experimental-builds/old-or-completed-feature-builds/layers.md)! This adds a new panel, which currently allows for 8 layers, including the main one. You can add, delete, clear, squash layers, and copy selected strokes to the currently selected layer.
...
Two new tools have been added to the advanced tools panel, [Snip and Join](../alternate-and-experimental-builds/old-or-completed-feature-builds/snip-tool.md). This works exactly as you'd expect, allowing you to cut strokes in half via their control points, giving you very fine control over the shape of strokes.
