...
[Unity and OpenXR](#unity-and-openxr)\
[Passthrough (Quest)](#passthrough-quest)\
[Layers](#layers)\
[Snip/Join strokes](#snipjoin-strokes)\
[Merged experimental support](#merged-experimental-support)\
[Vive XR Elite and Pico](#vive-xr-elite-and-pico)\
[Advanced camera tool](#advanced-camera-tools)\
[New import options](#new-import-options)\
[Pressure sensitive strokes](#pressure-sensitive-strokes)\
[Acknowledgements and Thank You!](#acknowledgements-and-thank-you)
...
Open Brush finally has [layers support](../user-guide/using-the-open-brush-tools-quick-tools-and-menu-panels/extras-panel/layers-panel.md)! This adds a new panel, which currently allows for 8 layers, including the main one. You can add, delete, clear, squash layers, and copy selected strokes to the currently selected layer.
...
Two new tools have been added to the [advanced tools panel](../user-guide/using-the-open-brush-tools-quick-tools-and-menu-panels/tools-panel/README.md): Snip and Join. These allow you to cut strokes at their control points or combine two strokes.
...
We've frequently heard from power users that we have too many builds floating around. They're not wrong! We've taken the decision to distribute [experimental mode](../user-guide/experimental-mode.md) inside the main release, but we've hidden it behind a toggle that requires a restart, in settings.
...
We dug into some of the unused features of the Tilt Brush code and found a handy [camera control panel](../user-guide/exporting-videos/camera-tool-gifs-snapshots-video.md)! Access this by long-pressing on your camera button.
...
We have added support for a few new filetypes, including [PLY point cloud data and WebM videos](../user-guide/importing-images-videos-3d-models.md)! You can add these via the media library, which is now accessible from the 'More Tools' panel.
