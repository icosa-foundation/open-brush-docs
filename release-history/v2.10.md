...
You can now [paint with other people in the same Open Brush room](../user-guide/multiplayer.md). Multiplayer synchronizes brush strokes and scene changes, includes spatial voice chat and gives the room owner controls for managing participants and deciding who can edit.

## Switch Experimental Brushes Without Restarting

[Experimental Brushes](../user-guide/experimental-mode.md) can now be shown or hidden while Open Brush is running. The switch only changes which brushes appear in the Brushes panel: sketches and multiplayer strokes can still load an experimental brush when the switch is off.

## Erase Imported Media

The Eraser can now [remove imported images, videos and 3D models](../user-guide/using-the-open-brush-tools-quick-tools-and-menu-panels/tools-panel/selection-options.md#erase-media-widgets) as well as brush strokes. Pinned media remains protected until you unpin it.

## Logitech MX Ink

Open Brush now supports the pressure-sensitive [Logitech MX Ink](../user-guide/logitech-mx-ink.md) stylus on compatible Meta Quest headsets.

## Full Change Log

[Full release details](https://github.com/icosa-foundation/open-brush/compare/2.9.0...2.10.0) and [official 2.10.0 release notes](https://github.com/icosa-foundation/open-brush/releases/tag/2.10.0)

## 🚀 Features

* [Multiplayer Beta](../user-guide/multiplayer.md) ([PR #774](https://github.com/icosa-foundation/open-brush/pull/774) by @andybak)
* [Switch experimental brushes on or off without a restart](../user-guide/experimental-mode.md#turning-on-experimental-brushes) ([PR #802](https://github.com/icosa-foundation/open-brush/pull/802) by @andybak)
* [Allow the erase tool to also "erase" media widgets](../user-guide/using-the-open-brush-tools-quick-tools-and-menu-panels/tools-panel/selection-options.md#erase-media-widgets) ([PR #818](https://github.com/icosa-foundation/open-brush/pull/818) by @andybak)
* [Logitech MX Ink Integration](../user-guide/logitech-mx-ink.md) ([PR #768](https://github.com/icosa-foundation/open-brush/pull/768) by Logitech and @andybak )
* Allow profiler to use bundled sketches ([PR #769](https://github.com/icosa-foundation/open-brush/pull/769) by @andybak)
* [Zapbox fixes: tutorial, controller materials, and laser pointer](../user-guide/platform-and-device-support.md#zapbox) ([PR #832](https://github.com/icosa-foundation/open-brush/pull/832) by @apzap)
* [Multiplayer fixes and improvements](../user-guide/multiplayer.md#manage-a-room) ([PR #809](https://github.com/icosa-foundation/open-brush/pull/809) by @sbanca)
