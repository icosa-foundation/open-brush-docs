...
Possibly our most powerful new feature ever and several years in the making. [Plugins](../user-guide/using-plugins/) are small Lua scripts that can hook into Open Brush to modify how existing painting tools work or create entirely new tools.
...
We've added the ability to break apart [imported models](../user-guide/importing-images-videos-3d-models.md#split-a-3d-model-into-separate-parts) - even if the model was built as a single mesh. We check for connected parts and allow you to break apart any elements that are visually separate.
...
We've now implemented the ability to [save any selected brush strokes](../user-guide/importing-images-videos-3d-models.md#save-and-reuse-selected-strokes) without converting them into a 3D mesh. When they are added back to your scene they remain grouped, editable strokes that can be ungrouped, recolored or rebrushed. The gallery includes several example saved-stroke items on a new installation.

## VOX File Import

<figure><img src="../.gitbook/assets/image-119.png" alt=""><figcaption></figcaption></figure>

The MagicaVoxel `.vox` format is used by a wide range of voxel editing apps. You can now [import VOX models](../user-guide/importing-images-videos-3d-models.md#vox-models) like other 3D model formats and construct entire scenes from them. If you want them to remain aligned to their original grid, set position snap to 0.1 and angle snap to 90 before importing.

## Publish Worlds to Viverse

<figure><img src="../.gitbook/assets/image-120.png" alt=""><figcaption></figcaption></figure>

You can now [publish Open Brush sketches directly to Viverse](../user-guide/saving-and-sharing-your-open-brush-sketches.md#publish-to-viverse-worlds) with a couple of clicks. [Viverse](https://www.viverse.com/) allows you to build and share 3D worlds in a web browser so people can visit from nearly any device: phones, tablets, PCs, Macs and VR headsets. Worlds are social and multiplayer and can optionally be monetized to help support artists.

## Import Open Blocks Models

<figure><img src="../.gitbook/assets/image-121.png" alt=""><figcaption></figcaption></figure>

Our sibling application [Open Blocks](https://openblocks.app/) is an intuitive low-poly 3D modelling app for PC, Quest and other standalone VR devices. Any [models you create and save locally](../user-guide/importing-images-videos-3d-models.md#open-blocks-models) appear in the standard Local Models browser. This release also added a **Try Open Blocks** button that opens the Open Blocks website.

## Camera Path Rendering on All Devices

<figure><img src="../.gitbook/assets/image-122.png" alt=""><figcaption></figcaption></figure>

[Camera paths](../user-guide/exporting-videos/camera-paths-tool.md) are a powerful way to render a standard or 360 video fly-through of your creations. However we only support rendering video directly on desktop (PC or Mac) and it was fiddly to copy sketches off standalone headsets such as the Quest and then render videos using the generated scripts.\
\
We've now made the process easier. You can render numbered video frames directly on devices that don't support generating video files. The accompanying sequence file records the frame rate, resolution and an example ffmpeg command. [Read the standalone Camera Path workflow](../user-guide/exporting-videos/quest-and-other-standalone-headsets.md#option-1-render-frames-on-quest-then-compile).

## More Selection Tools for Quest/standalone VR

<figure><img src="../.gitbook/assets/image-123.png" alt=""><figcaption></figcaption></figure>

Previously mobile VR devices such as the Quest had less selection tools available than PC VR devices. This was due to performance issues when we first launched for the Quest 1. Newer devices are more powerful so we've made the [full range of tools available](../user-guide/using-the-open-brush-tools-quick-tools-and-menu-panels/tools-panel/selection-options.md#selection-tools-on-queststandalone-vr) on all devices giving you access to "Select All" and "Invert Selection". Complex scenes might stutter when using these but we wanted to give you the choice.

## View-only Mode Improvements

<figure><img src="../.gitbook/assets/image-124.png" alt=""><figcaption></figcaption></figure>

Not enough people realise that Open Brush runs as a [sketch viewer](../user-guide/view-only-mode.md) on Mac, PC and Android devices even when those devices have no VR support. This release improved the navigation controls. Touch support on phones is more intuitive and standard gamepads should work as expected. Try installing from Steam on Steam Deck or similar handheld devices.
...
The Admin panel now includes a [What's New button](../user-guide/using-the-open-brush-tools-quick-tools-and-menu-panels/the-admin-panel/) for browsing recent features and announcements inside Open Brush. It is highlighted when an unread item is available.

## Full Change Log:

[Full release details](https://github.com/icosa-foundation/open-brush/compare/2.10.0...2.13.0) and [official 2.13.0 release notes](https://github.com/icosa-foundation/open-brush/releases/tag/2.13.0)

### 🚀 Features

* [Plugin scripting](../user-guide/using-plugins/) ([PR #699](https://github.com/icosa-foundation/open-brush/pull/699) by @andybak)
* [Enable axis locking for guides](../user-guide/using-the-open-brush-tools-quick-tools-and-menu-panels/extras-panel/transform-panel.md) ([PR #856](https://github.com/icosa-foundation/open-brush/pull/856) by @andybak)
* [Icosa Gallery Integration](../user-guide/saving-and-sharing-your-open-brush-sketches.md#icosa-gallery-integration) ([PR #865](https://github.com/icosa-foundation/open-brush/pull/865) by @andybak)
...
* [UI tweaks](../user-guide/using-the-open-brush-tools-quick-tools-and-menu-panels/extras-panel/) ([PR #877](https://github.com/icosa-foundation/open-brush/pull/877) by @andybak)
* [Mesh splitting](../user-guide/importing-images-videos-3d-models.md#split-a-3d-model-into-separate-parts) ([PR #880](https://github.com/icosa-foundation/open-brush/pull/880) by @andybak)
* [Harmonize panels between PC and mobile](../user-guide/using-the-open-brush-tools-quick-tools-and-menu-panels/tool-panels.md) ([PR #885](https://github.com/icosa-foundation/open-brush/pull/885) by @andybak)
* [Non VR View-only Mode improvements](../user-guide/view-only-mode.md) ([PR #888](https://github.com/icosa-foundation/open-brush/pull/888) by @andybak)
* [Save selected strokes](../user-guide/importing-images-videos-3d-models.md#save-and-reuse-selected-strokes) ([PR #711](https://github.com/icosa-foundation/open-brush/pull/711) by @andybak)
* [Still frame export](../user-guide/exporting-videos/quest-and-other-standalone-headsets.md#option-1-render-frames-on-quest-then-compile) ([PR #893](https://github.com/icosa-foundation/open-brush/pull/893) by @andybak)
* [Allow symmetry modes to affect Tool Plugin output](../user-guide/using-plugins/writing-plugins/writing-a-tool-plugin.md#tool-plugins-and-symmetry) ([PR #897](https://github.com/icosa-foundation/open-brush/pull/897) by @andybak)
* [Better saved strokes UX](../user-guide/importing-images-videos-3d-models.md#save-and-reuse-selected-strokes) ([PR #912](https://github.com/icosa-foundation/open-brush/pull/912) by @andybak)
* [Various small plugin scripting improvements](../user-guide/using-plugins/writing-plugins/writing-a-symmetry-plugin.md#advanced-symmetry-control) ([PR #916](https://github.com/icosa-foundation/open-brush/pull/916) by @andybak)
* [OBJ import improvements](../user-guide/importing-images-videos-3d-models.md#obj-models) ([PR #928](https://github.com/icosa-foundation/open-brush/pull/928) by @andybak)
* [Selective snap angle axes](../user-guide/using-the-open-brush-tools-quick-tools-and-menu-panels/extras-panel/snap-settings-panel.md#snap-axis-toggles) ([PR #930](https://github.com/icosa-foundation/open-brush/pull/930) by @andybak)
* [Send triangle count to Icosa on upload](../user-guide/saving-and-sharing-your-open-brush-sketches.md#upload-your-sketches) ([PR #945](https://github.com/icosa-foundation/open-brush/pull/945) by @andybak)
* [VOX import support](../user-guide/importing-images-videos-3d-models.md#vox-models) ([PR #947](https://github.com/icosa-foundation/open-brush/pull/947) by @andybak)
* [Local Open Blocks model loading](../user-guide/importing-images-videos-3d-models.md#open-blocks-models) ([PR #953](https://github.com/icosa-foundation/open-brush/pull/953) by @andybak)
* [Example saved strokes](../user-guide/importing-images-videos-3d-models.md#save-and-reuse-selected-strokes) ([PR #960](https://github.com/icosa-foundation/open-brush/pull/960) by @andybak)
* [Viverse publishing](../user-guide/saving-and-sharing-your-open-brush-sketches.md#publish-to-viverse-worlds) ([PR #944](https://github.com/icosa-foundation/open-brush/pull/944) by @andybak)
* [What's New panel and Open Blocks promotional button](../user-guide/using-the-open-brush-tools-quick-tools-and-menu-panels/the-admin-panel/) ([PR #952](https://github.com/icosa-foundation/open-brush/pull/952) by @andybak)
...
* Change how the UI is notified about new saved strokes ([PR #961](https://github.com/icosa-foundation/open-brush/pull/961) by @andybak)
* Make What's New and Open Blocks panels available in Beginner mode ([PR #964](https://github.com/icosa-foundation/open-brush/pull/964) by @andybak)
...
### [v2.13.1 follow-up](https://github.com/icosa-foundation/open-brush/releases/tag/2.13.1)
