...
Previously the only way to do this was to tap the bottom of the controllers together. This wasn't easy to discover and was unreliable when using some controllers. We've kept that in but added a [nice clear button in the app settings](https://github.com/icosa-gallery/open-brush-docs/blob/master/user-guide/switching-hands.md).

### Add a button in Setting to reset the "First Time Use" tutorial

This is something that's especially useful when you want to demo Open Brush to a new user. The current tutorial is very brief but we hope to expand it in the future. [Note this button affects the app the next time you launch it](../user-guide/using-the-open-brush-tools-quick-tools-and-menu-panels/the-admin-panel/settings.md#reset-to-first-time).
