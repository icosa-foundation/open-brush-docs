...
You don't need a VR headset to explore Open Brush sketches. [View-only mode](../user-guide/monoscopic-mode.md) now has a thumbnail grid for browsing local and curated Icosa sketches, improved loading and navigation, and touch controls for mobile devices.

This work also makes it easier for us to provide dedicated viewer builds on more platforms. View-only mode keeps the focus on exploring the artwork by hiding the painting tools and other controls you don't need.
