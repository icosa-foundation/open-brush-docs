...
<figure><img src="../.gitbook/assets/image-058 (1).png" alt="" width="273"><figcaption></figcaption></figure>
...
Load your own [360 panoramas](../user-guide/importing-images-videos-3d-models.md) and replace the default environment background. We support jpeg, png and we've added support for .hdr files as well.
...
Just by placing [SVG files](../user-guide/importing-images-videos-3d-models.md) in either your Media Library/Images folder or your Media Library/3D Models folder, you'll be able to import them either as raster images or as 3d meshes.
...
PC VR users will be familiar with the [audio reactive mode](../user-guide/make-moving-creations-using-audio-reactive-brushes.md) that allows many of the brushes to animate in response to music you play on your PC. We've now enabled this [mode for the Quest](../user-guide/make-moving-creations-using-audio-reactive-brushes.md) as well. Currently you need to import the audio as an mp4 video file but we plan to add support standard audio files as well as spatial audio and trigger modes for multiple clips.

## Camera Paths on all headsets

<figure><img src="../.gitbook/assets/image-073 (1).png" alt="" width="375"><figcaption></figcaption></figure>

You can now create and edit [camera paths](../user-guide/exporting-videos/camera-paths-tool.md) on the Quest and other standalone headsets. You currently can't generate a video directly from the headset. However we can copy your sketches to any PC or Mac (it doesn't have to be a VR capable PC) and render a video there. See below.
...
* [WebSocket support for API requests](../user-guide/open-brush-api/)
