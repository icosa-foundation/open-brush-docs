...
- Remove almost all uses of Experimental Mode, and combine [Monoscopic](../user-guide/monoscopic-mode.md) into the main releases (PR #674 by @andybak)
...
- [Import/export improvements](../user-guide/importing-images-videos-3d-models.md) (PR #573 by @andybak)
