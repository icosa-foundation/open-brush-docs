...
1. Configure Open Brush to build in Monoscopic mode \(see above\)
2. Configure Open Brush to export your .tilt file on startup -- go to the App.Config object, set the property "FakeCommandLineArgsInEditor" to --export "c:/yourfile.tilt"
