...
### Option 1: Render videos as separate frames and compile the video using other software

This is a new option released near the end of 2025. Now - you can render camera paths directly on the Quest. They are saved as individual frames and you'll need to compile them into a video using another piece of software.

We generate a batch file that will work with [ffmpeg](https://ffmpeg.org/) - or you can use any video editing software. We'll add a list of easy to use software here when we get some feedback from users.

### Option 2: Draw a Camera Path in the headset and render on a computer
...
### Option 3: Use native Quest video recording feature
